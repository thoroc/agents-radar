...
🇬🇧 英语 | [🇺🇦 Українська](./README.uk-UA.md) | [🇸🇦 巴里](./README.ar-SA.md) | [🇷🇺 Русский](./README.ru-RU.md) | [🇮🇳हिन्दी](./README.hi-IN.md) | [🇩🇪 德语](./README.de-DE.md) | [🇹🇷土耳其](./README.tr-TR.md) | [🇹🇭ไทย](./README.th-TH.md) | [🇵🇱 波兰斯基](./README.pl-PL.md) | [🇮🇹 意大利语](./README.it-IT.md) | [🇫🇷 法语](./README.fr-FR.md) | [🇨🇳 中文](./README.zh-CN.md) | [🇧🇷葡萄牙语](./README.pt-BR.md) | [🇻🇳Tiếng Việt](./README.vi-VN.md) | [🇧🇩বাংলা](./README.bn-BD.md) | [🇪🇸 西班牙语](./README.es-ES.md) | [🇮🇩 印尼语](./README.id-ID.md) | [🇷🇴 罗马尼亚语](./README.ro-RO.md) | [🇰🇷 韩语](./README.ko-KR.md) | [🇳🇱 荷兰语](./README.nl-NL.md) | [🇯🇵 日语](./README.ja-JP.md)

要启用其他语言的报告生成，请参阅[多语言支持](./docs/setup.md#multi-language-support)。

一个每天早上 8:00 CST 运行的 GitHub Actions 工作流。它聚合来自 10 个数据源的 AI 生态系统信号，然后以 GitHub Issues 和已提交 Markdown 文件的形式发布每日摘要（支持所有已配置语言）。此外，它还会自动生成每周和每月汇总报告。
...
| [GitHub 代码库](https://github.com) | API | 来自 17 个以上已跟踪 AI 工具代码库的 Issues、PR 和发布版本 |
...
| [Hacker News](https://news.ycombinator.com) | [Algolia API](https://hn.algolia.com/api) |过去 24 小时内最热门的 30 个 AI 相关新闻，6 个并行查询 |
...
| [Lobste.rs](https://lobste.rs) | JSON API |过去 7 天的 AI/ML 标记文章 |

| [Anthropic](https://anthropic.com) + [OpenAI](https://openai.com) | 网站地图 | 通过 `lastmod` diff 检测到新文章 |

## Web UI

**`PAGES_URL`** — 将此设置为仓库变量，以配置您 fork 的 Web UI 基本 URL。

在简洁的深色主题界面中浏览所有历史摘要 — 无需登录。报告通过 GitHub Pages 从此仓库中的 Markdown 文件渲染。

Web UI 是一个位于 `packages/web/` 目录下的 Vite + TypeScript 单页应用程序 (SPA)。它会在运行时获取 `manifest.json` 和各个摘要文件 — 新的每日摘要无需重新构建 UI 即可显示。
