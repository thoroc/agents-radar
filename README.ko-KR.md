...
🇬🇧 영어 | [🇺🇦 우크라이나어](./README.uk-UA.md) | [🇸🇦 아랍어](./README.ar-SA.md) | [🇷🇺 러시아어](./README.ru-RU.md) | [🇮🇳 힌디어](./README.hi-IN.md) | [🇩🇪 독일어](./README.de-DE.md) | [🇹🇷 터키어](./README.tr-TR.md) | [🇹🇭 태국어](./README.th-TH.md) | [🇵🇱 폴란드어](./README.pl-PL.md) | [🇮🇹 이탈리아노](./README.it-IT.md) | [🇫🇷 프랑스어](./README.fr-FR.md) | [🇨🇳 중국어](./README.zh-CN.md) | [🇧🇷 포르투갈어](./README.pt-BR.md) | [🇻🇳 Tiếng Viet](./README.vi-VN.md) | [🇧🇩 বাংলা](./README.bn-BD.md) | [🇪🇸 스페인어](./README.es-ES.md) | [🇮🇩 인도네시아](./README.id-ID.md) | [🇷🇴 Română](./README.ro-RO.md) | [🇰🇷 한국어](./README.ko-KR.md) | [🇳🇱 네덜란드어](./README.nl-NL.md) | [🇯🇵 일본어](./README.ja-JP.md)

보고서 생성을 위한 추가 언어를 활성화하려면 [다국어 지원](./docs/setup.md#multi-language-support)을 참조하세요.

이 GitHub Actions 워크플로는 매일 아침 8시(미국 중부 표준시)에 실행됩니다. 10개의 데이터 소스에서 AI 생태계 신호를 집계하여 구성된 모든 언어로 일일 요약 보고서를 GitHub 이슈와 커밋된 Markdown 파일로 게시합니다. 주간 및 월간 요약 보고서도 자동으로 생성됩니다.
...
[GitHub 리포지토리](https://github.com) | API | 추적 중인 17개 이상의 AI 도구 저장소의 이슈, PR, 릴리스 |
