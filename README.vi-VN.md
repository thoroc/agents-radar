...
🇬🇧 Tiếng Anh · 🇨🇳 中文 · 🇯🇵 日本語 · 🇰🇷 한국어 · 🇪🇸 Español · 🇧🇷 Português · 🇫🇷 Français · 🇩🇪 Deutsch · 🇮🇹 Italiano · 🇵🇱 Polski · 🇷🇺 Русский · 🇸🇦 العربية · 🇹🇷 Tiếng Thổ Nhĩ Kỳ · 🇻🇳 Tiếng Việt · 🇹🇭 ไทย · 🇳🇱 Tiếng Hà Lan · 🇮🇳 हिन्दी · 🇷🇴 Tiếng Romania · 🇮🇩 Tiếng Indonesia · 🇺🇦 Українська · 🇧🇩 Tiếng Bengali

Tiếng Anh | [Tiếng Trung](./README.zh-CN.md)
...
| [Xu hướng GitHub](https://github.com/trending) | HTML + API | Các kho lưu trữ đang thịnh hành hàng ngày + tìm kiếm chủ đề AI (cửa sổ 7 ngày) |

| [Tin tức Hacker](https://news.ycombinator.com) | [API Algolia](https://hn.algolia.com/api) | 30 câu chuyện AI hàng đầu trong 24 giờ qua, 6 truy vấn song song |

| [Product Hunt](https://www.producthunt.com) | API GraphQL | Các sản phẩm AI hàng đầu ngày hôm qua theo số phiếu bầu |

| [ArXiv](https://arxiv.org) | [API ArXiv](https://export.arxiv.org/api/query) | Các bài báo mới nhất từ cs.AI, cs.CL, cs.LG (48 giờ qua) |

| [Hugging Face](https://huggingface.co) | [API Hub](https://huggingface.co/api/models) | 30 mô hình thịnh hành được sắp xếp theo lượt thích hàng tuần |

| [Dev.to](https://dev.to) | [API Forem](https://dev.to/api) | Các bài viết AI/LLM hàng đầu từ 5 thẻ |
| [Lobste.rs](https://lobste.rs) | API JSON | Các bài viết được gắn thẻ AI/ML trong 7 ngày qua |
...
Giao diện người dùng web là một ứng dụng SPA Vite + TypeScript trong `packages/web/`. Nó lấy `manifest.json` và các tệp tóm tắt riêng lẻ trong thời gian chạy — các bản tóm tắt hàng ngày mới xuất hiện mà không cần xây dựng lại giao diện người dùng.
