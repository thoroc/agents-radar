...
const LocaleDataSchema = z.object({
  ...
  hackerNewsFetchFailed: z.string(),
  ...
  hackerNewsMeta: z.string(),
  productHuntMeta: z.string(),
  arxivMeta: z.string(),
  huggingFaceMeta: z.string(),
  communityMeta: z.string(),
  trendingMeta: z.string(),
  hackerNewsCount: z.string(),
  arxivCount: z.string(),
  productHuntCount: z.string(),
  huggingFaceCount: z.string(),
  ...
  issueLabelHackerNews: z.string(),
  issueLabelProductHunt: z.string(),
  issueLabelArxiv: z.string(),
  issueLabelHuggingFace: z.string(),
  ...
  issueTitleHackerNews: z.string(),
  issueTitleProductHunt: z.string(),
  issueTitleArxiv: z.string(),
  issueTitleHuggingFace: z.string(),
  ...
  reportLabelAiHackerNews: z.string(),
  reportLabelAiProductHunt: z.string(),
  reportLabelAiArxiv: z.string(),
  reportLabelAiHuggingFace: z.string(),
