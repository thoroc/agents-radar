...
🇬🇧 الإنجليزية · 🇨🇳 中文 · 🇯🇵 日本語 · 🇰🇷 한국어 · 🇪🇸 الإسبانية · 🇧🇷 البرتغالية · 🇫🇷 الفرنسية · 🇩🇪 الألمانية · 🇮🇹 Italiano · 🇵🇱 Polski · 🇷🇺 Русский · 🇸🇦 العربية · 🇹🇷 Türkçe · 🇻🇳 Tiếng Việt · 🇹🇭 التايلاندية · الهولندية · الهندية · الرومانية · الإندونيسية · الأوكرانية · البنغالية

الإنجليزية | الصينية

لتفعيل لغات إضافية لإنشاء التقارير، راجع [دعم اللغات المتعددة](./docs/setup.md#multi-language-support).

سير عمل GitHub Actions يُنفذ كل صباح الساعة 8:00 بتوقيت الصين القياسي. يجمع هذا النظام إشارات بيئة الذكاء الاصطناعي من 10 مصادر بيانات، ثم ينشر ملخصات يومية (بجميع اللغات المُهيأة) كملفات GitHub Issues وملفات Markdown المُلتزمة. كما يتم إنشاء تقارير تجميعية أسبوعية وشهرية تلقائيًا.
